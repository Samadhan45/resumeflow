...
const steps = ["CONTACT", "EXPERIENCE", "EDUCATION", "SKILLS", "ABOUT", "FINISH IT"];
          ...
          return (
            <React.Fragment key={name}>
              <div className="flex flex-col items-center">
                ...
                <p className={`mt-2 text-xs font-semibold ${isActive ? 'text-blue-500' : 'text-gray-500'}`}>
                  {name}
                </p>
              </div>
                ...
                <ResumeForm />
                 <div className="mt-8">
                    <Button onClick={nextStep} className="w-full" size="lg">
                        Next to Experience <Icons.arrowRight className="ml-2" />
                    </Button>
                </div>
            </div>
        </main>
      </div>
      <div className="resume-preview-container bg-gray-100 p-8 flex items-center justify-center">
