  ...
  return (
    <div className="space-y-8">
       <div className="text-center">
        <h1 className="text-3xl font-bold">Your <span className="text-primary">contact info</span></h1>
        <p className="text-muted-foreground mt-2">This allows employers to see how they can contact you.</p>
       </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                 <Label htmlFor="jobTitle2">Secondary Job Title</Label>
